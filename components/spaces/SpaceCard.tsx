        ...
        <CardContent className="flex flex-col items-center justify-between h-[450px]">
          ...
          <div>
            ...
            <p className="text-white font-light">
              Your own personal workspace, available for as long as you need.
              Settle in, stay focused and make it yours.
            </p>
            <Btn />
          </div>
        </CardContent>
      ...
      <Card className="flex flex-col items-center justify-center gap-5 bg-[#F9690E] py-4 rounded-xl">
        <CardContent className="flex flex-col items-center justify-between h-[450px]">
          ...
          <div>
            ...
            <p className="text-white font-light">
              Hot desk, dedicated desk, private office, meeting room, rest
              lounge, a conducive and innovative space
            </p>
            <Btn />
          </div>
        </CardContent>
      ...
      <Card className="flex flex-col items-center justify-center gap-5 bg-[#F9690E] py-4 rounded-xl">
        <CardContent className="flex flex-col items-center justify-between h-[450px]">
          ...
          <div>
            ...
            <p className="text-white font-light">
              Book the perfect meeting room for your team, fully equiped with
              everything you need to collaborate and create seamlessly
            </p>
            <Btn />
          </div>
        </CardContent>
      ...
      <Card className="flex flex-col items-center justify-center gap-5 bg-[#F9690E] py-4 rounded-xl">
        <CardContent className="flex flex-col items-center justify-between h-[450px]">
          ...
          <div>
            ...
            <p className="text-white font-light">
              Step into your own personal offices, designed for focus, comfort
              and success
            </p>
            <Btn />
          </div>
      ...
      {/*<Card className="flex flex-col items-center justify-center gap-5 bg-[#F9690E] py-4 rounded-xl">
        <CardContent className="flex flex-col items-center justify-between h-[450px]">
          ...
          <div>
            ...
            <p className="text-white font-light">
              Host your next big idea in our cozy, fully-equipped mini event
              space. Perfect for workshops, trainings, conferences, meetups or
              gatherings
            </p>
            <Btn />
          </div>
